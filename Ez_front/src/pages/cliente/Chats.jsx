...
/**
 * Chats Cliente - Sistema de mensajería en tiempo real
 * Gestiona conversaciones con ingenieros y soporte
 */
const ChatsCliente = () => {
  ...
  const [chats, setChats] = useState([
    { id: 1, nombre: 'Carlos García', avatar: 'C', lastMessage: 'El proyecto está avanzando...', timestamp: '10:30 AM', unread: 2 },
    { id: 2, nombre: 'María López', avatar: 'M', lastMessage: 'Perfecto, entendido', timestamp: 'Ayer', unread: 0 },
    { id: 3, nombre: 'Juan Pérez', avatar: 'J', lastMessage: 'Cuándo podemos comenzar?', timestamp: '2 días', unread: 1 },
  ]);
    ...
    if (selectedChat) {
      setMessages([
        ...
        },
        {
          ...
          senderId: selectedChat.id,
          senderName: selectedChat.nombre,
          content: 'He revisado los requisitos del proyecto...',
          timestamp: '10:15 AM',
          isMine: false,
        },
      ]);
  ...
  const chatItemStyle = (isSelected, hasUnread) => ({
    ...
    borderLeft: isSelected ? `4px solid ${theme.colors.accent.azul}` : '4px solid transparent',
  ...
  const messageBubbleStyle = (isMine) => ({
    ...
    padding: `${theme.spacing[2]} ${theme.spacing[3]}`,
    borderRadius: theme.borderRadius.md,
    backgroundColor: isMine ? theme.colors.accent.azul : theme.colors.primary.grisSoft,
  ...
  const helpOptionHoverStyle = {
    borderColor: theme.colors.accent.azul,
