...
/**
 * Perfil Cliente - Gestión de información personal
 * Permite editar foto, datos personales, descripción y preferencias
 */
const PerfilCliente = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    apodo: 'AnaMartinez',
    descripcion: 'Empresaria en la industria de tecnología, buscando desarrolladores para proyectos innovadores.',
  ...
  const avatarStyle = {
    ...
    fontSize: '4rem',
    overflow: 'hidden',
    border: `3px solid ${theme.colors.accent.azul}`,
  };
      ...
      <div style={containerStyle}>
        ...
        <div style={contentStyle}>
          ...
          <div style={pageHeaderStyle}>
            ...
            <p style={pageSubtitleStyle}>Gestiona tu información personal</p>
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={profileHeaderStyle}>
              ...
              {!isEditing && (
                <div style={userInfoStyle}>
                  ...
                  <div style={userRoleStyle}>Cliente</div>
                  ...
                  <div style={infoItemStyle}>
                    ...
                    <span style={infoValueStyle}>{profileData.empresa}</span>
                  </div>
                </div>
              )}
            </div>
            ...
            {isEditing ? (
              <>
                ...
                {/* Descripción */}
                <div style={formSectionStyle}>
                  <h2 style={formSectionTitleStyle}>Información Adicional</h2>
                  <div style={formGroupStyle}>
